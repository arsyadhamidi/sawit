...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('petani-peminjaman.create') }}" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($data->status == 'Diterima' || $data->status == 'Ditolak')
                                            ...
                                            @endif
                                        @else
                                            <form action="{{ route('petani-peminjaman.destroy', $data->id) }}"
                                                method="POST" class="d-flex">
                                                @csrf
                                                <a href="{{ route('petani-peminjaman.edit', $data->id) }}"
