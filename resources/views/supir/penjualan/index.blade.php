...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('supir-penjualan.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($penjualans as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('supir-penjualan.destroy', $data->id) }}" method="POST"
                                            class="d-flex">
                                            @csrf
                                            <a href="{{ route('supir-penjualan.edit', $data->id) }}"
