...
@section('menuSupirPembelian', 'active')
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('supir-pembelian.store') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('supir-pembelian.index') }}" class="btn btn-primary">
                                    ...
                                    <select name="petani_id" class="form-control @error('petani_id') is-invalid @enderror"
                                        ...
                                        @foreach ($petanis as $data)
                                            <option value="{{ $data->id }}"
                                                {{ old('petani_id') == $data->id ? 'selected' : '' }}>
                                                {{ $data->nama ?? '-' }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="pemuat_id" class="form-control @error('pemuat_id') is-invalid @enderror"
                                        ...
                                        @foreach ($pemuats as $data)
                                            <option value="{{ $data->id }}"
                                                {{ old('pemuat_id') == $data->id ? 'selected' : '' }}>
                                                {{ $data->nama ?? '-' }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="total_pembelian"
                                        ...
                                        value="{{ old('total_pembelian') }}" placeholder="Masukan Total Pembelian" readonly
                                        id="totalPembelian">
