...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('supir-pembelian.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($pembelians as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('supir-pembelian.destroy', $data->id) }}" method="POST"
                                            class="d-flex">
                                            @csrf
                                            <a href="{{ route('supir-pembelian.edit', $data->id) }}"
