...
<head>
    ...
    <title>Registrasi | UD Sawit Dongan</title>
    <!-- base:css -->
                ...
                <div class="row w-100 mx-0">
                    <div class="col-lg-4 mx-auto">
                        <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                            ...
                            <h6 class="font-weight-light">Silahkan Buat akun dengan benar.</h6>
                            <form class="pt-3" action="{{ route('registrasi.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <textarea name="alamat_domisili" class="form-control @error('alamat_domisili') is-invalid @enderror" rows="3"
                                ...
                                <div class="form-group">
                                    <textarea name="alamat_kebun" class="form-control @error('alamat_kebun') is-invalid @enderror" rows="3"
                                        placeholder="Alamat Kebun">{{ old('alamat_kebun') }}</textarea>
                                    @error('alamat_kebun')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
