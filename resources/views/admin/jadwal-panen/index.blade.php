...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('data-jadwalpanen.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($jadwals as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('data-jadwalpanen.destroy', $data->id) }}" method="POST"
                                            class="d-flex">
                                            @csrf
                                            <a href="{{ route('data-jadwalpanen.edit', $data->id) }}"
                                                class="btn btn-sm btn-outline-info">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <a href="{{ route('data-jadwalpanen.show', $data->id) }}"
