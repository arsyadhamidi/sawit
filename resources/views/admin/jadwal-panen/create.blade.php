...
@section('menuDataJadwalPanen', 'active')
@section('content')
    <div class="row">
    ...
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-jadwalpanen.store') }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('data-jadwalpanen.index') }}" class="btn btn-primary">
                    ...
                    <div class="card-body">
                            ...
                            <select name="petani_id" class="form-control @error('petani_id') is-invalid @enderror"
                                ...
                                @foreach ($petanis as $data)
                                    <option value="{{ $data->id }}"
                                        {{ old('petani_id') == $data->id ? 'selected' : '' }}>{{ $data->nama ?? '-' }}
                                    </option>
                                @endforeach
                            </select>
                            @error('petani_id')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="waktu_panen" class="form-control @error('waktu_panen') is-invalid @enderror"
                                ...
                                <option value="Per 1 minggu" {{ old('waktu_panen') == 'Per 1 minggu' ? 'selected' : '' }}>
                                    Per 1 minggu</option>
                                <option value="Per 2 minggu" {{ old('waktu_panen') == 'Per 2 minggu' ? 'selected' : '' }}>
                                    Per 2 minggu</option>
                                <option value="Per 3 minggu" {{ old('waktu_panen') == 'Per 3 minggu' ? 'selected' : '' }}>
                                    Per 3 minggu</option>
                                <option value="Per 4 minggu" {{ old('waktu_panen') == 'Per 4 minggu' ? 'selected' : '' }}>
                                    Per 4 minggu</option>
                            </select>
                            @error('waktu_panen')
                                <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="luas_kebun"
                                ...
                                value="{{ old('luas_kebun') }}" placeholder="Masukan Luas Kebun">
                            @error('luas_kebun')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="lokasi_kebun"
                                ...
                                value="{{ old('lokasi_kebun') }}" placeholder="Masukan Lokasi Kebun">
                            @error('lokasi_kebun')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
