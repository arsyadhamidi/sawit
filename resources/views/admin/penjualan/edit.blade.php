...
@section('menuDataPenjualan', 'active')
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-penjualan.update', $penjualans->id) }}" method="POST">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('data-penjualan.index') }}" class="btn btn-primary">
                                    ...
                                    <select name="supir_id" class="form-control @error('supir_id') is-invalid @enderror"
                                        ...
                                        @foreach ($supirs as $data)
                                            <option value="{{ $data->id }}"
                                                {{ $penjualans->supir_id == $data->id ? 'selected' : '' }}>
                                                {{ $data->nama ?? '-' }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="quantity_tbs"
                                        ...
                                        value="{{ old('quantity_tbs', $penjualans->quantity_tbs ?? '0') }}"
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="total_tbs"
                                        ...
                                        value="{{ old('total_tbs', $penjualans->total_tbs ?? '0') }}"
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="quantity_berondolan"
                                        ...
                                        value="{{ old('quantity_berondolan', $penjualans->quantity_berondolan ?? '0') }}"
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="total_berondolan"
                                        ...
                                        value="{{ old('total_berondolan', $penjualans->total_berondolan ?? '0') }}"
                            ...
                            <div class="col-lg">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="total_penjualan"
                                        ...
                                        value="{{ old('total_penjualan', $penjualans->total_penjualan ?? '0') }}"
