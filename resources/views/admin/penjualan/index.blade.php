...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('data-penjualan.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($penjualans as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('data-penjualan.destroy', $data->id) }}" method="POST"
                                            class="d-flex">
                                            @csrf
                                            <a href="{{ route('data-penjualan.edit', $data->id) }}"
