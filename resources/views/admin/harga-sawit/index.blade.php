...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <a href="{{ route('data-hargasawit.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($hargas as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('data-hargasawit.destroy', $data->id) }}" method="POST"
                                            class="d-flex">
                                            @csrf
                                            <a href="{{ route('data-hargasawit.edit', $data->id) }}"
