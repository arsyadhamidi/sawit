...
@section('content')
    ...
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-hargasawit.store') }}" method="POST">
                @csrf
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="harga_tbs"
                                class="form-control @error('harga_tbs') is-invalid @enderror" value="{{ old('harga_tbs') }}"
                                placeholder="Masukan Harga TBS">
                            @error('harga_tbs')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="harga_berondolan"
                                ...
                                value="{{ old('harga_berondolan') }}" placeholder="Masukan Harga Berondolan">
