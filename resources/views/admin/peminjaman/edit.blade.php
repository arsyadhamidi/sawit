                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-control @error('status') is-invalid @enderror"
                                ...
                                <option value="Diterima" {{ $peminjamans->status == 'Diterima' ? 'selected' : '' }}>
                                    Diterima
                                </option>
                                <option value="Ditolak" {{ $peminjamans->status == 'Ditolak' ? 'selected' : '' }}>Ditolak
                                </option>
                                <option value="Proses" {{ $peminjamans->status == 'Proses' ? 'selected' : '' }}>Proses
                                </option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">
