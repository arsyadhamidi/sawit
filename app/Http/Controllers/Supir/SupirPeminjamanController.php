...
class SupirPeminjamanController extends Controller
{
    public function index()
    {
        $users = Auth::user();
        $peminjamans = Peminjaman::where('users_id', $users->id)->latest()->get();
        return view('supir.peminjaman.index', [
    ...
    {
        return view('supir.peminjaman.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('supir-peminjaman.index')->with('success', 'Selamat ! Anda berhasil menambahkan data');
    }

    public function edit($id)
    {
        $peminjamans = Peminjaman::find($id);
        return view('supir.peminjaman.edit', [
            'peminjamans' => $peminjamans,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('supir-peminjaman.index')->with('success', 'Selamat ! Anda berhasil memperbaharui data');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('supir-peminjaman.index')->with('success', 'Selamat ! Anda berhasil menghapus data');
    }
}
